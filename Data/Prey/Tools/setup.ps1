...
try {
	...
	[System.Environment]::SetEnvironmentVariable("LUMA_PREY_BIN_PATH", $prey_bin_path, [System.EnvironmentVariableTarget]::User)
    
	# Display a confirmation message
	Write-Host "The `"LUMA_PREY_BIN_PATH`" user environment variable has been succesfully saved."
} 
catch {

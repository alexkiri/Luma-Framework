...
public:
   ...
   void PrintImGuiAbout() override
   {
      ImGui::Text("Luma for \"Deus Ex: Human Revolution - Director's Cut\" is developed by Pumbo and is open source and free.\nIf you enjoy it, consider donating.\n"
         "The mod is made to be used with the \"Gold Filter Restoration\" mod from \"CookiePLMonster\" (https://github.com/CookiePLMonster/DXHRDC-GFX/releases/), however it will partially work without that too.\n"

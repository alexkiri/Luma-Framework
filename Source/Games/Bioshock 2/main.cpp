...
//TODOFT5: check if BS2 and 3 need R11G11B10F to R16G16B16A16F upgrades. Mix the mods? UseLowPrecisionColorBuffer=False FloatingPointRenderTargets = True
...
#if UPGRADE_RESOURCES_8UNORM == 0 && UPGRADE_SWAPCHAIN_TYPE == 1
...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD ul_reason_for_call, LPVOID lpReserved)
{
   if (ul_reason_for_call == DLL_PROCESS_ATTACH)
   {
      ...
      Globals::DESCRIPTION = "BioShock 2 Luma mod";
      Globals::WEBSITE = "";
      Globals::VERSION = 1;

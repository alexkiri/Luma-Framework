...
cbuffer PER_BATCH : register(b0)
{
  ...
  row_major float2x4 cTexGenMat1 : packoffset(c4);
  row_major float2x4 cTexGenMat0 : packoffset(c6);
}
  ...
  out float4 o3 : COLOR1)
{
  ...
  p1.x = dot(cTexGenMat1._m00_m01_m03, r0.xyz);
  p1.y = dot(cTexGenMat1._m10_m11_m13, r0.xyz);
  o2.xyzw = v1.xyzw;
  o3.xyzw = v2.xyzw;

// ---- Created with 3Dmigoto v1.3.16 on Sat Oct 18 22:53:33 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = frac(r0.w);
  r3.zw = float2(0.0625,0.0625) * r3.xy;
  ...
  r0.w = 1;
  while (true) {
    r1.w = cmp((int)r0.w >= 16);
    if (r1.w != 0) break;
    r6.xy = r3.xy * float2(0.0625,0.0625) + r6.xy;
  ...
  r0.xyw = float3(0.0625,0.0625,0.0625) * r5.xyz;
  ...
  r2.xyz = -r5.xyz * float3(0.0625,0.0625,0.0625) + r2.xyz;

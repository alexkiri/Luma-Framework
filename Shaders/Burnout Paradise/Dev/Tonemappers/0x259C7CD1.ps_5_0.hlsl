// ---- Created with 3Dmigoto v1.3.16 on Sat Oct 18 22:53:29 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyz = BlurMatrixZZZ.xyz * r0.zzz + v2.xyz;
  ...
  r1.w = frac(r1.w);
  r2.xy = float2(0.25,0.25) * r0.zw;
  r2.xy = r2.xy * r1.ww + v1.xy;
  r3.xyz = SamplerSourceTexture.Sample(SamplerSource_s, r2.xy).xyz;
  r4.xyz = r3.xyz * r0.xxx;
  r3.xyz = -r3.xyz * r0.xxx + r3.xyz;
  ...
  while (true) {
    r3.w = cmp((int)r1.w >= 4);
    if (r3.w != 0) break;
    r2.zw = r0.zw * float2(0.25,0.25) + r2.zw;
    r5.xyz = SamplerSourceTexture.Sample(SamplerSource_s, r2.zw).xyz;
    r6.xyz = r5.xyz * r0.xxx;
    r5.xyz = -r5.xyz * r0.xxx + r5.xyz;
    r5.xyz = r0.yyy * r5.xyz + r6.xyz;
    r4.xyz = r5.xyz + r4.xyz;
    r1.w = (int)r1.w + 1;
  }
  r0.xyz = GlobalParams.xxx * r4.xyz;
  ...
  r1.w = r0.w * r0.w;
  r0.w = r1.w * r0.w;
  r0.xyz = r0.xyz * float3(0.25,0.25,0.25) + r0.www;

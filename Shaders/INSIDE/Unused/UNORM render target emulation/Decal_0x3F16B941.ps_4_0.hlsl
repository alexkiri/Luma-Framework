...
{
  float4 r0,r1,r2,r3,r4,r5,r6,r9,r10;
  r0.x = 1 / cb1[7].x;
  r1.xy = v1.xy / v0.w;
  r0.yzw = v2.xyz / v0.w;
  ...
  while (true) {
    if (r0i.w >= 24) break;
    r6.zw = min(r9.xy, r4.zw);
    r10.xyzw = t6.Load(int3(r6.zw, 0)).xyzw;
    r3.w = 1 / r10.x;
    r3.w = -cb1[7].y + r3.w;
    r5.z = r3.w * r0.x;
    r3.w = -r3.w * r0.x + r9.z;
    ...
    if (r3.w != 0) {
      ...
      r5.xy = r9.xy;
      r10.xyz = cmp(cb0[12].xyz < r5.xyz);
      r5.xyz = cmp(r5.xyz < cb0[13].xyz);
      r5.xyz = r5.xyz ? r10.xyz : 0;
      r3.w = r5.y ? r5.x : 0;
      r3.w = r5.z ? r3.w : 0;
      r3.w = r3.w ? r4.x : 0;
      if (r3.w != 0) {
        r10.xyzw = t6.Load(int3(r6.yw, 0)).xyzw;
        r3.w = 1 / r10.x;
        r3.w = -cb1[7].y + r3.w;
        r3.w = -r3.w * r0.x + r9.z;
        r4.x = cmp(0 < r3.w);
  ...
  r0.xz = r1.zw + r1.zw;
  int3 pixelCoords = int3(r0.xz, 0);
  r3.xyzw = t2.Load(pixelCoords).xyzw;
  r0.x = 0.629960537 + r3.w;
  r0.x = r0.x * r0.x;
  r0.x = r0.x * r0.x + 0.842509866;
  r4.xzw = r3.xyz * r0.x;
  r2.xyzw = t4.Load(pixelCoords).xyzw;
  r0.z = cb0[8].w * r2.w;
  r0.z = cmp(r0.z == 0.333333);
  r0.z = r0.z ? 1.000000 : 0;
  r2.xyz = -r3.xyz * r0.x + cb0[8].xyz;
  r0.xzw = r0.z * r2.xyz + r4.xzw;
  r1.z = r9.w * r9.w;
  r1.z = cb0[7].w * r1.z;
  r1.w = r4.y * r4.y;
  r1.w = r1.w * -4 + 1;

// ---- Created with 3Dmigoto v1.3.16 on Fri Sep 19 02:16:56 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = r1.zw * float2(0.0117647061,0.0117647061) + float2(-0.00588235306,-0.00588235306);
  r0.yz = float2(-0.0117647061,-0.0117647061) + r0.yz;
  r1.zw = cb0[9].yz + v0.xy;
  r1.zw = cb0[8].xy * r1.zw;
  r2.xyzw = t1.SampleLevel(s3_s, r1.zw, 0).xyzw;
  r1.zw = float2(0.125,0.125) * r1.xy;
  r0.yz = r2.ww * r1.zw + r0.yz;
  r3.y = 0.125 * r2.w;
  r3.zw = float2(0.5,0.5);
  r4.xyzw = t2.SampleLevel(s1_s, r3.yz, 0).xyzw;
  r4.xyz = cb0[6].zzz * r4.xyz + r0.xxx;
  r5.xyzw = t3.Sample(s0_s, r0.yz).xyzw;
  r0.w = 0.629960537 + r5.w;
  r0.w = r0.w * r0.w;
  r0.w = r0.w * r0.w + 0.842509866;
  r5.xyz = r5.xyz * r0.www;
  r5.xyz = r5.xyz * r4.xyz;
  r6.xyzw = t4.Sample(s2_s, r0.yz).xyzw;
  ...
  while (true) {
    ...
    r10.xyzw = t2.SampleLevel(s1_s, r3.xw, 0).xyzw;
  ...
  r1.xz = r1.xx + r1.yz;
  r0.w = r0.z * cb0[3].z + r1.x;
  r1.x = r1.y * r1.z;
  r1.x = sqrt(r1.x);
  r1.x = r1.x + r1.x;
  r0.w = r1.x * cb0[3].w + r0.w;
  r0.xyz = r0.xyz + -r0.www;
  ...
  r0.w = cmp(cb0[12].w < v1.y);
  r0.w = r0.w ? cb0[12].y : cb0[12].z;
  r1.x = 1 + -r0.w;
  r1.xyz = r1.xxx * float3(0.0980392173,0.121568628,0.141176477) + r0.www;
  r2.xyz = r2.xyz * float3(5,5,5) + float3(-2,-2,-2);
  r2.xyz = float3(0.00456620986,0.00456620986,0.00456620986) * r2.xyz;

...
{
  float4 r0,r1,r2;
  r0.xyz = HDRColorGradingLUTs__HDRColorGradingLUTsTextures00__TexObj__.Load(float4(vThreadID.xyz, 0)).xyz;
  ...
  r0.xyz = ColorCorrectContrast * r0.xyz + r0.w;
  r1.xyz = saturate(ColorCorrectColor.xyz);
  r0.xyz = r1.xyz * r0.xyz;
  r1.xyz = log2(abs(r0.xyz));
  r1.xyz = float3(0.416666657,0.416666657,0.416666657) * r1.xyz; // Linear to Gamma
  r1.xyz = exp2(r1.xyz);
  ...
  HDRColorGradingLUTs__HDRColorGradingLUTsBlendedTexture[vThreadID.xyz].xyz = float4(r0.xyz, 0);
}
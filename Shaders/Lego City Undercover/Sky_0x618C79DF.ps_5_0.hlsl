...
// TODO: make sure there's no other sky shader, there seems to be one per time of day or something so there's gotta be more!
void main(
  ...
  out float4 o2 : SV_Target2)
{
  ...
  r0.w = g_MaterialPS.fs_layer1_diffuse.w * v2.x;
  r2.x = r0.w * r1.w;
  r0.w = -r0.w * r1.w + 1;
...
#if ENABLE_HDR_BOOST
  //bool forceVanillaSDR = ShouldForceSDR(v0.xy); // TODO: add!
  // Make sky nice again

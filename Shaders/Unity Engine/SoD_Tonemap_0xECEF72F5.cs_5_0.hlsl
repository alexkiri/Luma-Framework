...
RWTexture2DArray<float4> _OutputTexture : register(u0);
...
void main(uint3 vThreadID : SV_DispatchThreadID)
{
  ...
  if (r0.x != 0) {
    ...
    r0.xyz = log2(r0.xyz);
    r2.xyz = (r0.xyz * float3(0.0734997839,0.0734997839,0.0734997839) + float3(0.386036009,0.386036009,0.386036009)); // LUMA: removed saturate()
  } else {
    r0.x = cmp(0 != cb1[6].w);
    if (r0.x != 0) {
  ...
  _OutputTexture[vThreadID.xyz] = float4(r2.xyz, 1.0);
}
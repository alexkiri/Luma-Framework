  ...
  out float4 o0 : SV_Target0)
{
  ...
  r7.xyz = lights[3].color.rgb * r4.xxx;
  r6.xyz = r3.www * r7.xyz + r6.xyz;
  r8.xyz = -v8.xyz * lights[4].worldVector.rgb + lights[4].worldVector.rgb;
  r3.w = dot(r8.xyz, r8.xyz);
  r3.w = rsqrt(r3.w);
  ...
  r5.xzw = lights[5].color.rgb * r5.xxx;
  r8.xyz = lights[4].color.rgb * r5.yyy;
  r6.xyz = r4.xxx * r8.xyz + r6.xyz;
  r9.xyz = -v8.xyz * lights[5].worldVector.rgb + lights[5].worldVector.rgb; // TODO: all of these .rgb etc are broken in all BS1 fog shaders...
  r4.x = dot(r9.xyz, r9.xyz);
  r4.x = rsqrt(r4.x);

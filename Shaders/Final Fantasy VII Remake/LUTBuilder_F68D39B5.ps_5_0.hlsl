// ---- Created with 3Dmigoto v1.4.1 on Sat Apr 19 18:50:26 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  rx = uiDest;
   state=0, constZero.eType=4, returnType=2, texture.eType=7, afImmediates[0]=0.000000
    r3.xyz = cmp((int3)r3.xyz == int3(32,32,32));
    r0.w = r3.y ? r3.x : 0;
    r0.w = r3.z ? r0.w : 0;
    ...
    r4.xyz = uiDest.xyz;
  // Unknown use of GetDimensions for resinfo_ from missing reflection info, need manual fix.
  //   resinfo_indexable(texture3d)(float,float,float,float)_uint r4.xyz, l(0), t3.xyzw
  // Example for texture2d type, uint return:
  tx.GetDimensions(0, uiDest.x, uiDest.y, uiDest.z);
  rx = uiDest;
   state=0, constZero.eType=4, returnType=2, texture.eType=7, afImmediates[0]=0.000000
    r4.xyz = cmp((int3)r4.xyz == int3(32,32,32));
    r0.w = r4.y ? r4.x : 0;
    r0.w = r4.z ? r0.w : 0;
    r1.z = (int)r0.w & 0x41f80000;
    ...
    o0.xyz = saturate(r0.yzw ? r2.xyz : r1.xyz);
    o0.w = 1;
  } else {
